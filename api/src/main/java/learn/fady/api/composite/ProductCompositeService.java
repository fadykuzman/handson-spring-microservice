...
public interface ProductCompositeService {
    ...
    @ApiResponses( value = {
            ...
            @ApiResponse(code = 422, message = "Unprocessable entity, input parameters" +
                    "caused the processing to fail. See response message for more information.")
    }
    )
    @GetMapping(
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 422, message =  "Unprocessable entity," +
                    " input parameters caused the processing to fail. " +
                    "See response message for more information")
    })
    @PostMapping(
